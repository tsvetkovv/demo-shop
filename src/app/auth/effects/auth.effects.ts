...
export class AuthEffects {
  ...
  constructor(private readonly actions$: Actions<LoginPageActions.LoginPageActionsUnion>, private readonly authService: AuthService, private readonly router: Router) {}
}
